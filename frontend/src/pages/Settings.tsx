        ...
        <div className="space-y-4 md:space-y-6">
          <div className="flex items-center justify-between p-3 md:p-4 rounded-lg border bg-muted/50">
            <div className="space-y-0.5">
              <Label htmlFor="enable-custom" className="text-sm md:text-base font-medium">{t('settings.enableCustomApi')}</Label>
              <p className="text-xs md:text-sm text-muted-foreground">{t('settings.enableCustomApiDesc')}</p>
            </div>
            <Switch
              id="enable-custom"
          ...
          <div className="space-y-2 md:space-y-3">
            <Label htmlFor="base-url" className="text-sm md:text-base">{t('settings.apiBaseUrl')}</Label>
            <Input
              id="base-url"
