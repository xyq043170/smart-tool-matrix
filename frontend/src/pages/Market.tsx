...
export default function MarketPage() {
  ...
  return (
    <>
      ...
      <section className="shell py-14 md:py-20" aria-labelledby="cooksift-title">
        <div className="rounded-3xl border border-border bg-card p-7 md:flex md:items-center md:justify-between md:gap-10 md:p-10">
          <div>
            <p className="text-xs font-bold uppercase tracking-[0.16em] text-primary">{tc('market.cookSiftLabel')}</p>
            <h2 id="cooksift-title" className="mt-2 text-2xl font-bold tracking-tight md:text-3xl">{tc('market.cookSiftTitle')}</h2>
            <p className="mt-3 max-w-2xl text-sm leading-7 text-muted-foreground">{tc('market.cookSiftDescription')}</p>
          </div>
          <a
